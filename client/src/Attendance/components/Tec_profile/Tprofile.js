...
const Tprofile = ({user}) => {
    ...
    return (
        <div className='card' style={{width:"60%",margin:"auto",marginTop:"40px",overflow:"hidden",padding:"10px"}}>
            {user && <>
                <div >
            ...
            Upload Image
                   ...
                   <div style={{display:"flex"}}>
                    <div style={{width:"5%"}}></div>
                       <div style={{width:"50%"}}>
                         <p><b>FullName:</b>{currentUser.user.name}{currentUser.user.surname}</p> 
                        
                          <p><b>Teaching Area:</b>{currentUser.user.teaching_area}</p>
                          <p><b>Date Of Birth:{currentUser.user.date_of_birth}</b>{}</p>
